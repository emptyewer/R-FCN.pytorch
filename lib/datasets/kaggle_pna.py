...
class kaggle_pna(imdb):
    def __init__(self, image_set, year, num_classes, devkit_path=None):
        imdb.__init__(self, 'pna_' + year + '_' + image_set+"_"+str(num_classes))
        self._year = year
        ...
        print("kaggle_pna.py, Number of Classes: {}".format(self.num_classes))
        sys.stdout.flush()
    ...
    def image_path_from_index(self, pid):
        ...
        sys.stdout.flush()
        if self._image_set == "train" or self._image_set == "trainval":
